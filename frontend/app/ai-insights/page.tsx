    ...
    <div className="flex min-h-screen bg-white dark:bg-[#0f1117]">
      ...
      <div className="flex-1 lg:ml-56 min-w-0">
        ...
        <div className="p-4 lg:p-8">
          ...
          {/* Prediction */}
          <div className="bg-white dark:bg-[#1a1d27] rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm p-4 lg:p-6 mb-4 lg:mb-5">
              ...
              <div>
                <div className="flex flex-wrap gap-2 lg:gap-3 mb-5">
                  {prediction.history.map(h => (
                    <div key={h.month} className="bg-gray-50 dark:bg-[#13151f] border border-gray-100 dark:border-gray-800 rounded-md px-3 lg:px-4 py-3 text-sm">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md px-3 lg:px-4 py-3 text-sm">
                ...
                <div className="bg-blue-600 rounded-md px-4 lg:px-5 py-4">
          ...
          <div className="bg-white dark:bg-[#1a1d27] rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm p-4 lg:p-6">
            ...
            {anomalyError ? (
              <p className="text-yellow-600 text-sm bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 px-4 py-3 rounded-md">{anomalyError}</p>
            ) : anomalies.length === 0 ? (
              ...
              <div className="flex flex-col gap-3">
                {anomalies.map(a => (
                  <div key={a.id} className="bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/20 rounded-md px-4 py-3">
